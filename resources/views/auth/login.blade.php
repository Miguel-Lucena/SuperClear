...
<div class="container-fluid">
  <div class="row no-gutter">
            ...
            <div class="col-md-9 col-lg-8 mx-auto">
              ...
              @csrf
                <div class="form-label-group">
                  <input type="email" id="inputEmail" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" placeholder="Correo Electronico" required autocomplete="email" autofocus>
                ...
                <div class="text-center">
                  @if (Route::has('password.request'))
                      <a class="small" href="{{ route('password.request') }}">¿Olvidó la contrseña?</a></div>
                  @endif
              </form>
            </div>
          </div>
    ...
    <div class="card card-signin flex-row my-5">
      <img src="/storage/images/vistas/login.jpg" alt="">
    </div>
  </div>
</div>
@endsection